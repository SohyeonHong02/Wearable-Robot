...
csv_file_path = 'mujoco/mujoco200/model/inverted/wearable/normal_continous_data.csv'
...
while 1:
    ...
    # LPF_pos_FE_L = LPF_pos_FE_L + noise
    # LPF_vel_FE_L = LPF_vel_FE_L + noise
    # LPF_pos_FE_R = LPF_pos_FE_R + noise
    # LPF_vel_FE_R = LPF_vel_FE_R + noise
    ...
    data_to_write.append(f"{LPF_pos_FE_L*RAD2DEG} {LPF_pos_FE_R*RAD2DEG} {LPF_vel_FE_L*RAD2DEG} {LPF_vel_FE_R*RAD2DEG} {gait_phs_L} {gait_torque_L}")
...
# glfw.terminate() 
print(data_to_write)
output_file_path = 'mujoco/240116_percent_data/leg_knee_model/170cm_60kg/0116_with_k3_66%_a05_assist_gaitphaseTorque.txt'
